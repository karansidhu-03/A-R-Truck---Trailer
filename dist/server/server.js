...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Cpdmmerw.js");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-DfUzVjA_.js"),
...
var server_default = createStartHandler();
//#endregion
export { server_default as default, createMiddleware as n, createStart as t };

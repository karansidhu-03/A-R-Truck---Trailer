    ...
    head: () => ({
      meta: [
        ...
        { title: "A&R Truck & Trailer Repairs Ltd. | Mobile Repair Calgary" },
        {
          name: "description",
          content:
            "On-site mobile truck and trailer repair serving Calgary, Airdrie, Okotoks, Cochrane, and Chestermere. Roadside assistance, CVIP inspections, diagnostics, brakes and suspension.",
        },
        ...
        { property: "og:title", content: "A&R Truck & Trailer Repairs Ltd." },
        {
          ...
          content:
            "On-site mobile truck and trailer repair serving Calgary & Area.",
        },
